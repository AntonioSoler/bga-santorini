...
class Eros extends SantoriniPower
{
  ...
  public function checkPlayerWinning(&$arg) {
    ...
    // Eros wins
    $arg['win'] = true;
    $msg = $this->game->playerManager->getPlayerCount() == 3 ?
        clienttranslate('${power_name}: ${player_name} joined its workers at same level')
      : clienttranslate('${power_name}: ${player_name} joined its workers at level 1');
